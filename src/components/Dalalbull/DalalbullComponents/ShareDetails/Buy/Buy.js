...
import './Buy.scss';
import { submitBuyOrShortSell, getPortfolio, getDashboard, getIsGoodTime } from '../../apicalls/apicalls';

const Buy = ({ symbol, current_price, total_transactions, cash_bal, setPortfolioDetails, setDashboardDetails }) => {
